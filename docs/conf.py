# -*- coding: utf-8 -*-
#
# py509L documentation build configuration file, created by
...
latex_documents = [
  ('index', 'py509.tex', u'py509 Documentation',
   authors, 'manual'),
]
...
man_pages = [
    ('index', 'pyopenssl', u'py509 Documentation',
     [authors], 1)
]
